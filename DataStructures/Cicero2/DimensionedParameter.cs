  ...
  /*      [Description("The numerical value of this dimensioned parameter, taking into account unit multipliers.")]
        ...
        */
        ...
        public DimensionedParameter(Units.Dimension dim)
        {
            ...
            this.parameter.variable = ResourceID.Null;
        ...
        /// <returns></returns>
        public double getBaseValue(Cicero2ResourceDictionary resourceDictionary)
        {
        ...
        public static double[] getBaseValues(List<ResourceID<DimensionedParameter>> list, Cicero2ResourceDictionary resourceDictionary)
        {
            ...
            for (int i = 0; i < list.Count; i++)
            {
                ans[i] = list[i].getBaseValue(resourceDictionary);
            }
            return ans;
        }

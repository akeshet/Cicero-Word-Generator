...
namespace DatabaseHelper
{
    public class DatabaseHelper
    {
        ...
        public DatabaseHelper() //Constructor - establishes the connection
        {

            string myConnectionString = "server=192.168.1.227;uid=root;" + "pwd=w0lfg4ng;database=filelist;";
        ...
        public void test() //Someone to make sure we can call the dll
        {
